<div class="border-body">
    <div class="row">
        <div class="col-md-9 justify-content-start">
            <button class="btn btn-sm btn-add" onClick="create()"><a  class="text-decoration-none text-light" >Add Type Of Employee</a></button>
        </div>
        ...
        <table class="table data-table" id="myTable">
            <thead class="table-head">
                <tr class="judul">
                    ...
                    <th scope="col" >No Terakhir Sistem</th>
                    <th scope="col" >Format Depan NIK</th>
            ...
            @foreach ($param as $par)
                ...
                <tr class="isi">
                    ...
                    <td class="name">{{ $par->jenis_kar }}</td>
                    <td class="name">{{ $par->no_urut }}</td>
                    <td class="name">{{ $par->format_depan_nik }}</td>
                    <td class="status">

<div id="paginate-content ">
    ...
    <table id="myTable" class="table data-table text-uppercase table-sort mt-3 ">
        <thead>
            <tr class="judul">
                <th scope="col">No</th>
            ...
            @else
                @forelse ($data as $key => $tm)
                    <tr class="isi">
                        ...
                        <td>{{ $tm->notes}}</td>
                        <td>
                            <a href="/storage/resign/{{$tm->dokumen}}" target="_blank" class="btn btn-sm " title="Download">
                                <svg width="91" height="38" viewBox="30 0 30 38" fill="none" xmlns="http://www.w3.org/2000/svg">

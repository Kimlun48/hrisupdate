  ...
  <div class="container">
    <div class="row">
      ...
      <div class="lay-button col-md-6 d-flex justify-content-end align-items-center">
        <a class="btn mr-3 custombtn" href="/transext">Employee Transfer</a>
        <a class="btn btn-primary custombtn-2" href="/employ/create_external">Add Employees Internal</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row content-head mt-3 md-3">
    ...
    <button class="btn filter-head" onclick="showMainMenu()" type="button" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="dropdown-menu dropcrl" id="mainMenu">
        ...
        <a class="dropdown-item" href="#" onclick="showSubMenu('brandSubMenu')">Brand
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
            <path d="M9.07929 15.5058L12.6312 11.9538L9.07929 8.4019C8.72227 8.04488 8.72227 7.46815 9.07929 7.11112C9.43632 6.7541 10.013 6.7541 10.3701 7.11112L14.572 11.313C14.929 11.6701 14.929 12.2468 14.572 12.6038L10.3701 16.8057C10.013 17.1627 9.43632 17.1627 9.07929 16.8057C8.73142 16.4487 8.72227 15.8628 9.07929 15.5058Z" fill="#323232"/>
          </svg>
        </a>
        <a class="dropdown-item" href="#" onclick="showSubMenu('vendorSubMenu')">Vendor
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
            <path d="M9.07929 15.5058L12.6312 11.9538L9.07929 8.4019C8.72227 8.04488 8.72227 7.46815 9.07929 7.11112C9.43632 6.7541 10.013 6.7541 10.3701 7.11112L14.572 11.313C14.929 11.6701 14.929 12.2468 14.572 12.6038L10.3701 16.8057C10.013 17.1627 9.43632 17.1627 9.07929 16.8057C8.73142 16.4487 8.72227 15.8628 9.07929 15.5058Z" fill="#323232"/>
          </svg>
        </a>
      ...
      <div class="dropdown-menu dropcrl" id="statusSubMenu">
        <a class="dropdown-item" href="#" onclick="goBackToMainMenu('statusSubMenu')"><i class="fas fa-arrow-left"></i> Kembali ke Menu</a>
      ...
      <div class="dropdown-menu dropcrl" id="branchSubMenu">
        ...
        @foreach ($cabs as $cbg)
          <label class="dropdown-item" for="{{ $cbg->nama }}">
            <input class="cabangCheckbox" type="checkbox" id="{{ $cbg->nama }}" value="{{ $cbg->id }}">
            {{ $cbg->nama }}
          </label>
        @endforeach
      </div>

      <div class="dropdown-menu dropcrl" id="brandSubMenu">
        <a class="dropdown-item" href="#" onclick="goBackToMainMenu('brandSubMenu')"><i class="fas fa-arrow-left"></i> Kembali ke Menu</a>
        <input type="text" class="form-control" placeholder="Cari..." onkeyup="searchSubMenu('brandSubMenu', this)">
        @foreach ($brands as $brd)
          <label class="dropdown-item" for="{{ $brd }}">
            <input class="brandCheckbox" type="checkbox" id="{{ $brd }}" value="{{ $brd}}">
            {{ $brd }}
          </label>
        @endforeach
      </div>

      <div class="dropdown-menu dropcrl" id="vendorSubMenu">
        <a class="dropdown-item" href="#" onclick="goBackToMainMenu('vendorSubMenu')"><i class="fas fa-arrow-left"></i> Kembali ke Menu</a>
        <input type="text" class="form-control" placeholder="Cari..." onkeyup="searchSubMenu('vendorSubMenu', this)">
      ...
      <div class="dropdown-menu dropcrl" id="jobpositionSubMenu">
        <a class="dropdown-item" href="#" onclick="goBackToMainMenu('jobpositionSubMenu')"><i class="fas fa-arrow-left"></i> Kembali ke Menu</a>
      ...
      <div class="dropdown-menu dropcrl" id="joblevelSubMenu">
        <a class="dropdown-item" href="#" onclick="goBackToMainMenu('joblevelSubMenu')"><i class="fas fa-arrow-left"></i> Kembali ke Menu</a>
    ...
    <div class="dropdown col-md-4 d-flex justify-content-end align-items-center custom-filter" >
      ...
      <div class="dropdown-menu check" onclick="event.stopPropagation();" aria-labelledby="dropdownMenuButton">
        ...
        <label class="dropdown-item">
          <input type="checkbox" name="check" id="col22Checkbox" onchange="toggleColumn('col22')" checked/>
          Martial Status
        </label>
      ...
      {{-- <a href="/employ/bulkupdateexternal" class="Bulk">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 38 38" fill="none">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="col" action="{{ route('employ.exportemployeexternal') }}" method="POST" enctype="multipart/form-data" id="exportFormInternal">
            @csrf
...
<script type="text/javascript">
  ...
  function handleStatusChange() {
   ...
   $.ajax({
     ...
     url: '{{ url("employ/index_read_external") }}',
     data: {
       status: statusAktif,
...
<script>
  document.getElementById('exportFormInternal').addEventListener('submit', function(event) {
    ...
    if (employStatusSelected === 'Select Employment status' || branchSelected === 'Select Branch' || organizationSelected === 'Select Organization') {
      ...
      Swal.fire({
        ...
        document.getElementById('exportFormInternal').submit();
      });
    }
  });
</script>

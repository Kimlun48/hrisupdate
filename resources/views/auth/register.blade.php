...
@section('content')
    <form method="post" action="{{ route('register.perform') }}">
        ...
        <h1 class="h3 mb-3 fw-normal">Regissster</h1>
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" name="phone_number" value="{{ old('phone_number') }}" placeholder="phone number" required="required" autofocus>
        ...
        <div class="form-group form-floating mb-3">
            <input type="password" class="form-control" name="confirm_password" value="{{ old('confirm_password') }}" placeholder="Confirm Password" required="required">

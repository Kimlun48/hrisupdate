<div class="card card-attendance" >
    <div class="container container-card-attendance">
        ...
        <div class="col-sm col-card-attendance">
            ...
            <h4 class="text-content-2">{{$karyawan}}</h4>
            <h4 class="text-title-1">Employees</h4>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h4 onClick="ontime()" class="text-content-3">{{$ontime}}</h4>
            <h4 class="text-title-1">On Time</h4>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h4 onClick="late()" class="text-content-3">{{$late}}</h4>
            <h4 class="text-title-1">Late Clock In</h4>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h4 onClick="early()" class="text-content-3">{{$earlyin}}</h4>
            <h4 class="text-title-1">Early Clock In</h4>
            </div>
        </div>
        <div class="col-sm col-card-attendance"  >
            <div class="card card-content" >
            <h4 onClick="attend()" class="text-content-3">{{$attend}}</h4>
        ...
        <div class="texthead"  >
            ...
            <div class="card card-content">
            <h3 onClick="absen()" class="text-content-3">{{$absen}}</h3>
            <h3 class="text-title-1">Absent</h3>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h3 onClick="noclockin()" class="text-content-3">{{$noclockin}}</h3>
            <h3 class="text-title-1">No Clock in</h3>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h3 onClick="noclockout()" class="text-content-3">{{$noclockout}}</h3>
        ...
        <div class="texthead">
            ...
            <div class="card card-content">
            <h2 onClick="dayoff()" class="text-content-3">{{$dayoff}}</h2>
            <h2 class="text-title-1">Day Off</h2>
            </div>
        </div>
        <div class="col-sm col-card-attendance">
            <div class="card card-content">
            <h2 onClick="timeoff()" class="text-content-3">{{$timeoff}}</h2>

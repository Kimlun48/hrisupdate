  ...
  <div class="container">
    <div class="row">
      <div class="head-title col-md-6">
        <h5 class="title-detail">Detail Attendance Internal</h5>
      </div>
...
<div class="head-attend-detail container">
  <div class="row content-head mt-3 md-3">
    ...
    <div class="filter-date col-md-2 form-group">
      <select id="select-state" onclick="selectText(this)" onchange="changeProfile(this)">
...
@include('presensi.partials.scriptsdetail')
...
$(document).ready(function(){
  ...
  function readdetail() {
        $.get("{{ url('/presensi/readdetail') }}/"+idtes,{},
      function(data,status){
        $("#readdetail").html(data);
      });
    }
  function readcounter() {
        $.get("{{ url('/presensi/countdetail') }}/"+idtes,{},
      function(data,status){
        $("#counter").html(data);
      });
    }

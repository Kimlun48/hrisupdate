...
<!-- AWAL UNTUK COUNTDETAIL EXTERNAL -->
<script>

  function ontime_detail_external() {
    ...
    $.get("{{ url('/presensi/detail/external/ontime') }}", { tanggal: tanggalValue }, 
        function(data, status) {
            $("#todayLabel").html('Ontime External Detail');
            $("#todaydata").html(data);
  ...
  //Late today
  function late_detail_external() {
    $.get("{{ url('/presensi/detail/external/latein') }}",{}, 
    function(data,status){
        $("#todayLabel").html('LateIn External Detail');
        $("#todaydata").html(data);
        $("#todayPresensi").modal('show');    
      });
  }
  //Attend today
  function attend_detail_external() {
    $.get("{{ url('/presensi/detail/external/attend') }}",{}, 
    function(data,status){
        $("#todayLabel").html('Attend External Detail');
        $("#todaydata").html(data);
        $("#todayPresensi").modal('show');    
      });
  }
  //Attend Time Off
  function timeoff_detail_external() {
    $.get("{{ url('/presensi/detail/external/timeoff') }}",{}, 
    function(data,status){
        $("#todayLabel").html('TimeOff External Detail');
        $("#todaydata").html(data);
        $("#todayPresensi").modal('show');    
      });
  }
  //Attend Day Off
  function dayoff_detail_external() {
    $.get("{{ url('/presensi/detail/external/dayoff') }}",{}, 
    function(data,status){
        $("#todayLabel").html('DayOff External Detail');
        $("#todaydata").html(data);
        $("#todayPresensi").modal('show');    
      });
  }

  function absen_detail_external() {
    $.get("{{ url('/presensi/detail/external/absen') }}",{}, 
    function(data,status){
        $("#todayLabel").html('Absen External Detail');
        $("#todaydata").html(data);
        $("#todayPresensi").modal('show');    
      });
  }
  ...
  //Early today
  function earlyin_detail_external() {
    $.get("{{ url('/presensi/detail/external/earlyin') }}",{}, 
    function(data,status){
      $("#todayLabel").html('EarlyIn External Detail');
      $("#todaydata").html(data);
      $("#todayPresensi").modal('show');    
    });
  }
    //Noclockin today
  function noclockin_detail_external() {
    $.get("{{ url('/presensi/detail/external/noclockin') }}",{}, 
    function(data,status){
      $("#todayLabel").html('No Clock In External Detail');
      $("#todaydata").html(data);
      $("#todayPresensi").modal('show');    
    });
  }
  //Noclockout today
  function noclockout_detail_external() {
    $.get("{{ url('/presensi/detail/external/noclockout') }}",{}, 
    function(data,status){
      $("#todayLabel").html('No Clock Out External Detail');
      $("#todaydata").html(data);
      $("#todayPresensi").modal('show');    
    });
  }
...
<!-- AKHIR UNTUK COUNTDETAIL EXTERNAL -->

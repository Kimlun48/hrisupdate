...
<div class="tableling" id="employee-content">
  ...
  @forelse ($prs as $presensi)
    <tr class="isi" @if($presensi->presensi_status === 'Off') style="color: red;" @endif>
      ...
      <td class="keterangan text-center zui-sticky-col" onClick="edit({{$presensi->id}}, '{{$presensi->preskaryawan->nama_lengkap}}')" style="cursor: pointer; background-color: #ffffff !important;" >

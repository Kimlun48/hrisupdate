...
@section('content-attend')
  <div class="attendance">
    <div class="container">
      ...
      <h5 class="title-vacancy">Employees Attendance</h5>
      <hr class="border"></hr>
        ...
        <div class="row row-card-attendance">
          ...
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">Employees</h5>
              <h5 class="text-content-2">{{$karyawan}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">EarlyIn</h5>
              <h5 onClick="early()" class="text-content-3">{{$earlyin}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">OnTime</h5>
              <h5 onClick="ontime()" class="text-content-3">{{$ontime}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">LateIn</h5>
              <h5 onClick="late()" class="text-content-3">{{$late}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">Attend</h5>
              <h5 onClick="attend()" class="text-content-3">{{$attend}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">TimeOff</h5>
              <h5 onClick="timeoff()" class="text-content-3">{{$timeoff}}</h5>
            </div>
          </div>
          <div class="col-sm col-card-attendance">
            <div class="card card-content">
              <h5 class="text-content-1">DayOff</h5>
              <h5 onClick="dayoff()" class="text-content-3">{{$dayoff}}</h5>
            </div>
          </div>
      ...
      <div class="content-attendance">
        <div class="table-body">
          <h5 class="list-attendance">List Employees Attendance</h5>

              <div class="search-attendance">
                <form action="/presensi" method="GET" class="search">
                  <h6 class="list-applicant" style="font-size: 14px;">Search Attandance</h6>
      ...
      <br>  
            ...
            <thead class="table-head">
              <tr class="judul">
                ...
                <th scope="col" class="keterangans">Note Clock In</th>
                <th scope="col" class="clock-ins">Clock In</th>
                <th scope="col" class="clock-outs">Clock Out</th>
                <th scope="col" class="desks">Description</th>
            ...
            <tbody class="table-content">
              @forelse ($prs as $key => $presensi)
                <tr class="isi" @if($presensi->presensi_status === 'Off') style="color: red;" @endif>
                  ...
                  <td class="keterangan">{{$presensi->keterangan}}</td>
                  <td class="clock-in">
			...
			@endif
                  ...
                  <td style="display:none;">{{ $presensi->image_masuk }}</td>
                  <td style="display:none;">{{ $presensi->image_pulang }}</td>
                  @empty

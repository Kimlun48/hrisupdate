<div class="border-body">
  <div class="row">
      <div class="col-md-9 justify-content-start">
          <button class="btn btn-sm btn-add" onclick="createparperiod()"><a  class="text-decoration-none text-light" >Add Periode</a></button>
      </div>
    ...
    <table class="table data-table" id="myTable">
        <thead class="table-head">
            <tr class="judul">
              ...
              <th scope="col" onclick="sortTable(2)">End Date</th>
              <th scope="col" onclick="sortTable(3)">Status</th>
              <th scope="col" onclick="sortTable(4)"colspan="2">action</th>
            </tr>
        </thead>
        <tbody>        
          @foreach($param as $index => $item)
            <tr class="isi">
              ...
              <td class="name">{{$item->startdate}}</td>
              <td class="name">{{$item->enddate}}</td>
              <td class="status">

...
<script type="text/javascript">
    ...
    function read() {
        $.get("{{ url('/parperiode/readparam') }}", {}, function(data, status) {
            $("#readperiod").html(data);
        });
    }
...
// Close Modal
    ...
    function edit(id) {
        $.get("{{ url('/parperiode/edit/') }}/"+id, {}, function(data, status) {
            $("#ModalCreateLabel").html('Edit Param Periode');
            $("#page").html(data);
            $("#ModalCreate").modal('show');
        });
    }

    function createparperiod() {
        $.get("{{ url('/parperiode/create') }}", {}, function(data, status) {
    ...
    function storeedit(id) {
        ...
        $.ajax({
            url: "{{ url('/parperiode/storeedit') }}/"+id,
            data: formData,
            cache: false,
            processData: false,
            contentType: false,

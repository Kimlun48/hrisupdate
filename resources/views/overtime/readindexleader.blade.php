            ...
            @forelse ($data as $ot)
                ...
                <tr class="isi">
                    ...
                    <td class="actions">
                        ...
                        <button class="btn btn-sm btn-success " onClick="approveovertime({{$ot->id}})">
                            <i class="fas fa-calendar-check"></i></button>
                        <button class="btn btn-sm btn-danger btn-reject" onClick="rejectovertime({{$ot->id}})">
                            <i class="fas fa-window-close"></i></button>              
                        <button class="btn btn-sm btn-primary btn-reject" onClick="detailovertime({{$ot->id}})">
                            <i class="fas fa-pencil-alt"></i></button>              
                        <!-- <button class="btn btn-sm btn-primary mb-2" onClick="detail({{$ot->id}})">
                        <i class="fas fa-pencil-alt" style="color:#fff;"></i></button>  -->

...
<div class="param-perusahaan">
  <div class="head">
    <h5 class="title-applicant">List Company</h5>
  </div>
  <div class="container">
      ...
      <div class="border-body">
        <div class="row">
          <div class="col-md-9 justify-content-start">
            <button class="btn btn-sm btn-add" onclick="window.location.href = '{{ route('perusahaan.create') }}'">
        ...
        <table class="table data-table" id="myTable">
          ...
          <tbody>
              ...
              <tr class="isi">
                ...
                <td class="nama">{{ $pt->nama }}</td>
                <td class="code">{{ $pt->kode }}</td>
                <td class="status">
                  <div class="bg_status" data-status="{{ $pt->status }}">
                    {{ $pt->status }}
                  </div>
                </td>
                <td class="actions">
                  <a class="bg-edit" href="/perusahaan/edit/{{$pt->id}}">

<div class="border-body">
  <div class="row">
    <div class="col-md-9 justify-content-start">
      <button class="btn btn-sm btn-add" onclick="showtransferexternal()"><a  class="text-decoration-none text-light" >Create Transfer</a></button>
    </div>
  ...
  <div class="table-responsive">
    <table class="table data-table table-sort" id="myTable">
        <thead class="table-head">
            ...
            <th scope="col" class="action" onclick="sortTable(7)">Action</th>
            </tr>
        </thead>
        <tbody>
